<template>
  <!--
    AppProgress — horizontal value meter in the dungeon-console family.
    ...
    Structural layers (outer → inner):
      ...
      3. dungeon-progress__nameplate   (conditional — only rendered when `label` prop is present)
                              ...
                              AppFrame's nameplate. The ring gap
      ...
      4. dungeon-progress__inset   Recessed teal-dark content surface — same radial
                              top-bloom + linear depth gradient as AppFrame's
      ...
      7. dungeon-progress__readout   Footer band inside the inset. Same style and
                              background as AppFrame's __footer zone.
    ...
    Structural relationship to the family:
      · Outer shell and ring are unchanged from AppFrame.
...
/* ─────────────────────────────────────────────────────────────
   ...
   Identical to AppFrame .dungeon-frame__ring.
...
/* ─────────────────────────────────────────────────────────────
   ...
   Identical construction to AppFrame .dungeon-frame__nameplate:
...
/* ─────────────────────────────────────────────────────────────
   ...
   as AppFrame .dungeon-frame__inset. The interior contains the
   track bar and readout footer rather than free-form body/slot
   content, but the structural surface treatment is shared.
   ───────────────────────────────────────────────────────────── */
...
/* ─────────────────────────────────────────────────────────────
   ...
   Same style as AppFrame .dungeon-frame__footer:
