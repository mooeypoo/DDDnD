 ...
 * ──────────────────────────────────────────
 * Card is a lightweight subordinate to DungeonFramePrototype.
...
<style scoped>
/*
  All --dng-* tokens come from dungeon-design-tokens.css, loaded globally via
  .storybook/preview.ts. DO NOT @import here — breaks variant override scoping.
...
/* ─────────────────────────────────────────────────────────────
   ...
   Top is slightly brigher; bottom darker. Implies bronze material
...
/* ─────────────────────────────────────────────────────────────
   ...
   Matches card.svg which shows corner ornaments only at the bottom.
   ───────────────────────────────────────────────────────────── */
.dungeon-bracket {
  position: absolute;
...
/* ─────────────────────────────────────────────────────────────
   ...
   A single border-bottom (--dng-divider, the same bronze divider
   token used in the inset footer) is the only structural mark.
   The ring shows behind the text. The label reads as engraved into
   the face, not mounted on top of it.

   Card.svg reference: the header zone fill is #546864 — a muted
   teal-dark that blends into the bronze family rather than contrasting
   as a separate charcoal plate. This informs the no-background approach.
   ───────────────────────────────────────────────────────────── */
